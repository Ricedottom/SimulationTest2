...
define("../../../bower_components/almond/almond",
function() {}),
function(e, t) {
...
function(window, noGlobal) {
    ...
    function showHide(e, t) {
        ...
        for (; o < u; o++) {
            ...
            n = r.style.display,
            t ? (!s[o] && n === "none" && (r.style.display = ""), r.style.display === "" && isHidden(r) && (s[o] = data_priv.access(r, "olddisplay", defaultDisplay(r.nodeName)))) : s[o] || (i = isHidden(r), (n && n !== "none" || !i) && data_priv.set(r, "olddisplay", i ? n: jQuery.css(r, "display")))
        }
        for (o = 0; o < u; o++) {
            r = e[o];
            if (!r.style) continue;
    ...
    function defaultPrefilter(e, t, n) {
        ...
        e.nodeType === 1 && ("height" in t || "width" in t) && (n.overflow = [h.overflow, h.overflowX, h.overflowY], f = jQuery.css(e, "display"), f === "none" && (f = defaultDisplay(e.nodeName)), f === "inline" && jQuery.css(e, "float") === "none" && (h.display = "inline-block")),
        n.overflow && (h.overflow = "hidden", l.always(function() {
        ...
        if (!jQuery.isEmptyObject(c)) {
            ...
            for (r in c) o = createTween(p ? d[r] : 0, r, l),
            r in d || (d[r] = o.start, p && (o.end = o.start, o.start = r === "width" || r === "height" ? 1 : 0))
        }
    }
            ...
            if (e === undefined) {
                if (this.length) {
                    ...
                    if (s.nodeType === 1 && !data_priv.get(s, "hasDataAttrs")) {
                        n = o.length;
                        while (n--) r = o[n].name,
                        r.indexOf("data-") === 0 && (r = jQuery.camelCase(r.slice(5)), dataAttr(s, r, i[r]));
    ...
    jQuery.Event = function(e, t) {
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || e.defaultPrevented === undefined && e.getPreventDefault && e.getPreventDefault() ? returnTrue: returnFalse) : this.type = e,
    ...
    jQuery.extend({
        ...
        style: function(e, t, n, r) {
            ...
            if (!o || !("set" in o) || (n = o.set(e, n, r)) !== undefined) a[t] = "",
            a[t] = n
        },
    ...
    function(e, t) {
        jQuery.cssHooks[t] = {
            get: function(e, n, r) {
                if (n) return e.offsetWidth === 0 && rdisplayswap.test(jQuery.css(e, "display")) ? jQuery.swap(e, cssShow,
                function() {
    ...
    jQuery.fn.load = function(e, t, n) {
        ...
        var r, i, s, o = this,
        u = e.indexOf(" ");
        return u >= 0 && (r = e.slice(u), e = e.slice(0, u)),
...
define("sim-common/VersionCheck",
function() {}),
define("text", ["module"],
function(e) {
    "use strict";
    ...
    t = {
        ...
        parseName: function(e) {
            ...
            return s !== -1 && (!o || s > 1) ? (t = e.substring(0, s), n = e.substring(s + 1)) : t = e,
            r = n || t,
            s = r.indexOf("!"),
    ...
    if (d.env === "node" || !d.env && typeof process != "undefined" && process.versions && !!process.versions.node && !process.versions["node-webkit"] && !process.versions["atom-shell"]) n = require.nodeRequire("fs"),
...
define("text!sim-common/templates/notSupported.html", [],
function() {
...
function() {
    ...
    function k(e, t, n) {
        return function(r, i, s) {
            ...
            else if (n && s && a) return s = n(r, i),
            r[s] === i ? s: -1;
            if (i !== i) return s = t(o.call(r, u, a), d.isNaN),
            s >= 0 ? s + u: -1;
    ...
    typeof exports != "undefined" ? (typeof module != "undefined" && module.exports && (exports = module.exports = d), exports._ = d) : e._ = d,
    d.VERSION = "1.8.3";
    ...
    d.throttle = function(e, t, n) {
        ...
        return function() {
            var f = d.now(); ! u && n.leading === !1 && (u = f);
            var l = t - (f - u);
            return r = this,
            i = arguments,
            l <= 0 || l > t ? (o && (clearTimeout(o), o = null), u = f, s = e.apply(r, i), o || (r = i = null)) : !o && n.trailing !== !1 && (o = setTimeout(a, l)),
            s
        }
    },
    ...
    d.each(["Arguments", "Function", "String", "Number", "Date", "RegExp", "Error"],
    function(e) {
        d["is" + e] = function(t) {
...
define("api/snapshot/util/uuid", ["require"],
function(e) {
    var t = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split(""),
    n = function() {
        var e = "",
        n;
        for (var r = 0; r < 46; r++) n = 0 | Math.random() * 36,
        e += t[n];
        return e
    };
    return n
}),
define("api/snapshot/SimCapiMessage", ["require"],
function(e) {
    var t = function(e) {
        e = e || {},
        this.type = e.type || null,
        this.handshake = e.handshake || {
            requestToken: null,
            authToken: null
        },
...
function(e, t, n) {
    ...
    i = function(e, t, n) {
        if (e) throw Error(e);
        var r = "" + n.constructor;
        throw r = (typeof n).length < r.length ? typeof n: r,
        Error("Expected: " + n.name + ". Actual : " + (t ? t.constructor.name: t))
    },
    s = function(e, t, n) {
        var s = !1;
        if (n.each) {
    ...
    n = t.exports),
    "function" == typeof define && define.amd && define("check", [],
    function() {
        return u
    }),
    n = t.exports = u,
...
define("api/snapshot/SimCapiTypes", ["require"],
function(e) {
    var t = function(e, t) {
        this.enumValue = e,
        this.stringValue = t
    ...
    var n = {
        NUMBER: new t(1, "Number"),
        STRING: new t(2, "String"),
        ARRAY: new t(3, "Array"),
        BOOLEAN: new t(4, "Boolean"),
        ENUM: new t(5, "Enum"),
        MATH_EXPR: new t(6, "MathExpression"),
        ARRAY_POINT: new t(7, "Point Array")
    },
    r = Object.keys(n).reduce(function(e, t) {
        var r = n[t];
        return e[t] = r.valueOf(),
        e
    },
    {}),
    i = Object.keys(n).reduce(function(e, t) {
        var r = n[t];
        return e[r.valueOf()] = r.toString(),
        e
    },
    {}),
    s = function(e) {
...
define("api/snapshot/SimCapiValue", ["check", "./SimCapiTypes"],
function(e, t) {
    function n(t) {
    ...
    var s = function(s) {
        ...
        if (this.type) this.value = u(this.value, this.type, this.allowedValues);
            ...
            this.type = o(this.value, this.allowedValues),
            this.type === t.TYPES.ARRAY && e(this.value).passive().isString() && (this.value = r(this.value))
        }
...
define("api/snapshot/config/apiList", [],
function() {
    return {
...
define("api/snapshot/ApiInterface", ["require", "./config/apiList", "./SimCapiMessage", "api/snapshot/Transporter"],
function(e) {
    function r() {
        this.apiCallUid = 0,
        this.responseQueue = {}
    ...
    r.prototype.apiCall = function(e, r, i, s) {
        ...
        typeof s == "function" && (this.responseQueue[o] = s),
        this.transporter.sendMessage(a)
    },
    r.prototype.processResponse = function(e) {
        var t = this.responseQueue[e.values.uid];
        if (!t) return;
        t(e.values.type, e.values.args),
        delete this.responseQueue[e.values.uid]
    },
    r
}),
define("api/snapshot/LocalData", [],
function() {
    function t(e, t) {
    ...
    var e = {
        ...
        setData: function(e, n, r, i) {
            try {
                var s = JSON.parse(window.sessionStorage.getItem(e)) || {};
                s[n] = r,
                window.sessionStorage.setItem(e, JSON.stringify(s))
            } catch(o) {
...
define("api/snapshot/util/domain", [],
function() {
    return {
        getDomain: function() {
...
define("api/snapshot/Transporter", ["jquery", "underscore", "api/snapshot/util/uuid", "api/snapshot/SimCapiMessage", "check", "api/snapshot/SimCapiValue", "./ApiInterface", "./LocalData", "./util/domain"],
function(e, t, n, r, i, s, o, u, a) {
    ...
    var f = function(f) {
        ...
        m = [],
        g = {
            requestToken: f.requestToken || n(),
            authToken: f.authToken || null,
            version: l
        },
        ...
        var O = function(e) {
            e.handshake.authToken === g.authToken && (e.values.responseType === "success" ? S[e.values.simId][e.values.key].onSuccess({
                key: e.values.key,
                value: e.values.value,
                exists: e.values.exists
            }) : e.values.responseType === "error" && S[e.values.simId][e.values.key].onError(e.values.error), delete S[e.values.simId][e.values.key])
        },
        M = function(e) {
            if (e.handshake.authToken === g.authToken) {
                var t = x[e.values.simId][e.values.key];
                delete x[e.values.simId][e.values.key],
                e.values.responseType === "success" ? t.onSuccess({
                    key: e.values.key,
                    value: e.values.value
                }) : e.values.responseType === "error" && t.onError(e.values.error)
            }
        };
        this.getDataRequest = function(e, t, n, s) {
            ...
            s = s ||
            function() {};
            if (!W() || X()) return u.getData(e, t, n),
            !0;
            var o = new r({
                type: r.TYPES.GET_DATA_REQUEST,
                handshake: g,
                values: {
                    key: t,
                    simId: e
            ...
            return S[e] || (S[e] = {}),
            S[e][t] ? new Error("Get data request of " + t + " already in progress.") : (S[e][t] = {
                onSuccess: n,
                onError: s
            },
            g.authToken ? c.sendMessage(o) : b.forHandshake.push(o), !0)
        },
        this.setDataRequest = function(e, t, n, s, o) {
            ...
            o = o ||
            function() {};
            if (!W() || X()) return u.setData(e, t, n, s),
            !0;
            var a = new r({
                type: r.TYPES.SET_DATA_REQUEST,
                handshake: g,
                values: {
                    key: t,
                    value: n,
            ...
            return x[e] || (x[e] = {}),
            x[e][t] ? new Error("Set data request of " + t + " already in progress.") : (x[e][t] = {
                onSuccess: s,
                onError: o
            },
            g.authToken ? c.sendMessage(a) : b.forHandshake.push(a), !0)
        };
        var D = function(e) {
            H("complete", e),
            w = !1
        ...
        H = function(e, t) {
            var n = [];
            for (var r in E.check[e]) E.check[e][r].handler(t),
            E.check[e][r].once && n.push(E.check[e][r]);
        ...
        F = function(e) {
            if (e.handshake.authToken === g.authToken) {
                ...
                t.each(e.values,
                function(e, t) {
                    e && !e.readonly && (h[t] && h[t].value !== e.value ? (h[t].setValue(e.value), n.push(h[t])) : h[t] || (p[t] = e.value, n.push(new s({
                        value: e.value,
                        key: t
                    }))))
                }),
        ...
        I = function(e) {
            if (e.handshake.requestToken === g.requestToken) {
                g.authToken = e.handshake.authToken,
                g.config = e.handshake.config;
                if (y) {
                    c.notifyOnReady();
        ...
        q = function() {
            var e = new r({
                type: r.TYPES.HANDSHAKE_REQUEST,
                handshake: g
            });
            c.sendMessage(e)
        };
        ...
        this.triggerCheck = function(e) {
            ...
            w = !0,
            e = e || {},
            e.complete && c.addCheckCompleteListener(e.complete, !0);
            var t = new r({
                type: r.TYPES.CHECK_REQUEST,
                handshake: g
            });
            b.forValueChange.push(t),
            c.notifyValueChange()
        },
        this.requestParentContainerResize = function(e, t) {
            ...
            i = new r({
                type: r.TYPES.RESIZE_PARENT_CONTAINER_REQUEST,
                handshake: g,
                values: {
                    messageId: n,
                    width: e.width,
            ...
            this.messageCallbacks[n] = {
                onSuccess: t
            },
            g.authToken ? c.sendMessage(i) : b.forHandshake.push(i)
        };
        var R = function(e) {
            var t = e.values.messageId,
            n = c.messageCallbacks[t];
            delete c.messageCallbacks[t],
            e.values.responseType === "success" && n.onSuccess()
        },
        U = function() {
            if (a.getDomain().indexOf("smartsparrow.com") === -1) return a.setDomain("smartsparrow.com");
            a.setDomain("smartsparrow.com")
        };
        this.requestInternalViewerAccess = function() {
            var e = new r({
                type: r.TYPES.ALLOW_INTERNAL_ACCESS,
                handshake: this.getHandshake()
            });
            c.sendMessage(e)
        },
        this.notifyValueChange = function() {
            return g.authToken && N === null && (N = setTimeout(function() {
        ...
        this.createValueChangeMsg = function() {
            var e = new r({
                type: r.TYPES.VALUE_CHANGE,
                handshake: c.getHandshake()
            });
            return e.values = h,
            e
        },
        ...
        var z = function(e) {
            ...
            n = h[e],
            r;
            return t ? (r = t, delete p[e]) : n && (r = n.value),
            r
        };
...
define("api/snapshot/adapters/BackboneAdapter", ["underscore", "api/snapshot/Transporter", "api/snapshot/SimCapiMessage", "api/snapshot/SimCapiValue", "api/snapshot/SimCapiTypes", "check"],
function(e, t, n, r, i, s) {
    var o = function(n) {
        ...
        this.expose = function(t, n, u) {
            ...
            if (n.has(t)) {
                ...
                c = new r({
                    ...
                    type: u.type,
                    readonly: u.readonly,
                    writeonly: u.writeonly,
                    allowedValues: u.allowedValues,
                    bindTo: u.bindTo
                });
        ...
        this.unexpose = function(t, n) {
            var r;
            o[t] ? r = o[t] : r = e.findWhere(o, {
                originalName: t,
                model: n
            });
            if (!r) throw new Error(t + " doesn't exist on the model.");
            n.off("change:" + r.originalName, r.exposeFunc),
            s.removeValue(r.alias),
            delete o[r.alias]
        },
        this.exposeModel = function(t) {
            e.each(t.capiProperties, e.bind(function(e, n) {
                e.model = t,
                this.expose(n, e)
            },
            this))
...
define("api/snapshot/Controller", ["api/snapshot/Transporter"],
function(e) {
    return {
        notifyOnReady: e.getInstance().notifyOnReady,
        triggerCheck: e.getInstance().triggerCheck,
        getData: e.getInstance().getDataRequest,
        setData: e.getInstance().setDataRequest
    }
}),
define("ComponentLibrary", [],
function() {
    "use strict";
    var e = {};
    return {
...
function() {
    ...
    n("../../bower_components/almond/almond",
    function() {}),
    n("componentize", [],
    function() {
        function e(e, t) {
        ...
        function s(e) {
            e.destroy && e.destroy();
            var t;
            for (t in this.components) if (this.components[t] === e) {
                delete this.components[t];
                break
            }
            delete this.notStartedComponents[t],
            delete this.updatableComponents[t],
            e.componentName && delete e.entity[e.componentName],
            e.entity = null
        }
        function o() {
            var e;
        ...
        function h(e) {
            this.runComponentsStart(e),
            this.runComponentsUpdate(e)
        }
        function p(e) {
            var t, n;
            for (t in this.notStartedComponents) {
                n = this.notStartedComponents[t],
                n.start(e);
                if (n.destroyed) continue;
                n.update && (this.updatableComponents[t] = n),
                delete this.notStartedComponents[t]
            }
        }
        function d(e) {
        ...
        return function(e, u, v) {
            e.notStartedComponents = {},
            e.updatableComponents = {},
            e.components = {},
            e.children = {},
            v = v || {};
            var m = 0,
            ...
            e.addComponent = function() {
                ...
                return Object.defineProperty(s, "componentName", {
                    configurable: !1,
                    enumerable: !1,
                    writable: !1,
                    value: e
            ...
            e.addChild = function(e, t) {
                ...
                this.children[e] = t,
                t.parent = this,
                v.updateChildName && v.updateChildName(t, e)
            },
            e.getComponent = r,
            e.getComponents = i,
            e.removeComponent = s,
    ...
    n("system", ["require", "componentize"],
    function(e) {
        function o(e) {
            if (n[e].destroyed) {
                var t = r[e];
                return n[e].removeAllComponents(),
                delete n[e],
                i[t] && i[t].destroyed && delete i[t],
                delete r[e],
                !0
            }
            return ! 1
        ...
        function a(e, t) {
            var n = r[e.UID],
            s = r[e.parent.UID] + "." + t;
            n && (delete i[n], u(e, n.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"), s)),
            r[e.UID] = s,
            i[s] = e
        }
        ...
        return {
            ...
            start: function() {
                for (var e in n) n[e].removeAllComponents(),
                n[e].destroy();
                n = {},
                r = {},
                i = {},
...
function(e, t, n) {
    ...
    return function(e) {
        ...
        r = i = n = function(r, i, s, a, f) {
            ...
            a ? t(e, r, i, s) : setTimeout(function() {
                t(e, r, i, s)
            },
            4),
            n
    ...
    s("../../bower_components/almond/almond",
    function() {}),
    s("constants", [],
    function() {
        var e = {};
        return Object.defineProperty(e, "FACTORY", {
            value: "+",
            enumerable: !0
        }),
        Object.defineProperty(e, "REFERENCE", {
            value: "&",
            enumerable: !0
        }),
        Object.defineProperty(e, "INJECTION", {
            value: "~",
            enumerable: !0
        }),
        ...
        Object.defineProperty(e, "PATTERN_ALL", {
            value: "*",
            enumerable: !0
        }),
        Object.defineProperty(e, "PATTERN_SELF", {
            value: "",
            enumerable: !0
        }),
        Object.defineProperty(e, "PATTERN_PARENT", {
            value: "^",
            enumerable: !0
        }),
        e
    }),
    s("ResolutionProperty", ["require", "constants"],
    function(e) {
        var t = e("constants"),
        n = function(e, t, n) {
            this.component = t,
        ...
        var r = function(e, n, r) {
            var s = r.shift(),
            o = n[s] || null;
            return s === t.PATTERN_PARENT ? o = e.parent || null: s === t.PATTERN_SELF && (o = e || null),
            i(o, r)
        },
        i = function(e, n) {
    ...
    s("ComponentQuery", ["require", "constants", "ResolutionProperty"],
    function(e) {
        var t = e("constants"),
        ...
        i = {
            addResolutionProperties: function(e, t) {
                for (var r in t) if (t.hasOwnProperty(r) && s(t[r])) e.push(new n(t.entity, t, r));
            ...
            resolveComponentReferences: function(e, t, n, r) {
                ...
                try {
                    ...
                    i.component[i.propName] = i.resolve(e, t, n),
                    r.shift()
                } catch(s) {
        ...
        s = function(e) {
            return typeof e == "string" && e.length > 0 && r.reduce(function(t, n) {
                return n === e[0] || t
            },
            !1)
        };
    ...
    s("EntityFactory", ["require", "constants", "jquery"],
    function(e) {
        var t = e("constants"),
        n = e("jquery"),
        r = function(e, t) {
        ...
        r.prototype.create = function(e) {
            e = e || {};
            var t = this.scene.addEntity(e.name, n.extend(!0, {},
            this.config, e.config)),
            r = i(e.references);
            return this.scene.resolveReferences(r),
            t
        };
        var i = function(e) {
            var n = {};
    ...
    s("Scene", ["require", "ComponentSystem", "ComponentLibrary", "ComponentQuery", "EntityFactory", "jquery"],
    function(e) {
        ...
        u.prototype.addComponent = function(e, t, i) {
            ...
            i),
            u = i.componentName || t,
            delete i.componentName,
            o = n.getComponent(u),
            a = e.addComponent(t, o, i),
            r.addResolutionProperties(this.references, a),
            a
        },
        ...
        var a = function(e) {
            var t = {};
            return t.id = e && e.id || o++,
            t.entities = e ? s.extend(!0, {},
            e.entities) : {},
            t.factories = e ? s.extend(!0, {},
            e.factories) : {},
            t
        },
        f = function() {
    ...
    s("Time", ["require", "ComponentSystem", "jquery"],
    function(e) {
        var t = e("ComponentSystem"),
        n = e("jquery"),
        r = function(e) {
        ...
        r.prototype.update = function(e) {
            this.ts = e,
            this.playing ? (s.call(this), t.update(this)) : i.call(this)
        },
        r.create = function(e) {
            return new r(e)
        };
    ...
    s("Manager", ["require", "ComponentSystem", "Scene", "Time", "jquery", "./PerformancePolyfill"],
    function(e) {
        "use strict";
        var t = e("ComponentSystem"),
        n = e("Scene"),
        ...
        var s = {
            ...
            lastUpdate: 0,
            create: function(e) {
                this.parent = e.parent || document.body,
                this.$el = i(this.parent),
                this.Time = r.create(e.pauseOnBlur === !1 ? !1 : e.pauseOnBlur || !0),
                o(e),
                t.start(),
                requestAnimationFrame(i.proxy(this.update, this))
            },
            startScene: function(e) {
                var t = this.Scenes[e] || this.Scenes[Object.keys(this.Scenes)[0]];
                return this.ActiveScene && this.ActiveScene.unload(),
                this.$el.append(t.$el),
                this.ActiveScene = t,
            ...
            update: function(e) {
                e = e || performance.now(),
                this.ActiveScene && this.ActiveScene.resolveReferences(),
                this.Time.update(e),
                requestAnimationFrame(i.proxy(this.update, this))
            }
        },
...
define("componentLibrary-Renderers/HtmlRenderer", ["require", "jquery", "SceneManager"],
function(e) {
    function b(e, t, n, o, u, a, f, l) {
        var c = "",
        h = "";
        if (t !== null || n !== null || o !== null || u !== null || a !== null || f !== null || l !== null) c = "translate3d(" + (t || 0) + r + ", " + (n || 0) + r + ", 0px) " + "rotate3d(0, 0, 1, " + (o || 0) + i + ") " + "scale3d(" + (u || 1) + ", " + (a || 1) + ", 1) " + "skewX(" + (f || 0) + s + ") " + "skewY(" + (l || 0) + s + ")",
...
define("componentLibrary-Renderers/TextRenderer", ["require", "./HtmlRenderer"],
function(e) {
    var t = e("./HtmlRenderer"),
    n = function() {
        t.apply(this),
        this.__super__ = t.prototype,
        this.text = ""
    };
    n.prototype = new t,
...
define("componentLibrary-Renderers/TemplateRenderer", ["require", "jquery", "underscore", "ComponentLibrary", "./HtmlRenderer"],
function(e) {
    var t = e("jquery"),
    n = e("underscore"),
    ...
    var o = function() {
        ...
        this.$el = t(n.template(e)(this.templateData)),
        this.class && this.$el.addClass(this.class);
...
function(e) {
    ...
    e.widget.extend = function(t) {
        ...
        o,
        u;
        for (; i < s; i++) for (o in r[i]) u = r[i][o],
        r[i].hasOwnProperty(o) && u !== undefined && (e.isPlainObject(u) ? t[o] = e.isPlainObject(t[o]) ? e.widget.extend({},
        t[o], u) : e.widget.extend({},
        u) : t[o] = u);
        return t
    },
    e.widget.bridge = function(t, r) {
        ...
        e.fn[t] = function(s) {
            ...
            return o ? this.each(function() {
                ...
                n = r[s].apply(r, u);
                if (n !== r && n !== undefined) return a = n && n.jquery ? a.pushStack(n.get()) : n,
                !1
    ...
    e.Widget.prototype = {
        ...
        _createWidget: function(n, r) {
            ...
            this.options, this._getCreateOptions(), n),
            this._create(),
        ...
        option: function(t, n) {
            ...
            if (typeof t == "string") {
                ...
                t = i.shift();
                if (i.length) {
                    s = r[t] = e.widget.extend({},
                    this.options[t]);
                    for (o = 0; o < i.length - 1; o++) s[i[o]] = s[i[o]] || {},
                    s = s[i[o]];
                    t = i.pop();
        ...
        _setOption: function(e, t) {
            ...
            e === "disabled" && (this.widget().toggleClass(this.widgetFullName + "-disabled", !!t), t && (this.hoverable.removeClass("ui-state-hover"), this.focusable.removeClass("ui-state-focus"))),
            this
        },
        enable: function() {
    ...
    e.widget("ui.mouse", {
        ...
        _mouseDown: function(n) {
            ...
            if (this._mouseDistanceMet(n) && this._mouseDelayMet(n)) {
                ...
                if (!this._mouseStarted) return n.preventDefault(),
                !0
            }
            return ! 0 === e.data(n.target, this.widgetName + ".preventClickEvent") && e.removeData(n.target, this.widgetName + ".preventClickEvent"),
...
function(e) {
    ...
    return e.widget("ui.draggable", e.ui.mouse, {
        ...
        _setOption: function(e, t) {
            this._super(e, t),
            e === "handle" && (this._removeHandleClassName(), this._setHandleClassName())
        },
        _destroy: function() {
        ...
        _mouseStart: function(t) {
            ...
            this._trigger("start", t) === !1 ? (this._clear(), !1) : (this._cacheHelperProportions(), e.ui.ddmanager && !n.dropBehaviour && e.ui.ddmanager.prepareOffsets(this, t), this._normalizeRightBottom(), this._mouseDrag(t, !0), e.ui.ddmanager && e.ui.ddmanager.dragStart(this, t), !0)
        },
        ...
        _mouseStop: function(t) {
            ...
            this.options.revert === "invalid" && !r || this.options.revert === "valid" && r || this.options.revert === !0 || e.isFunction(this.options.revert) && this.options.revert.call(this.element, r) ? e(this.helper).animate(this.originalPosition, parseInt(this.options.revertDuration, 10),
            function() {
        ...
        _createHelper: function(t) {
            ...
            return i.parents("body").length || i.appendTo(n.appendTo === "parent" ? this.element[0].parentNode: n.appendTo),
        ...
        _getParentOffset: function() {
            ...
            n = this.document[0];
            return this.cssPosition === "absolute" && this.scrollParent[0] !== n && e.contains(this.scrollParent[0], this.offsetParent[0]) && (t.left += this.scrollParent.scrollLeft(), t.top += this.scrollParent.scrollTop()),
    ...
    e.ui.plugin.add("draggable", "connectToSortable", {
        ...
        drag: function(t, n, r) {
            ...
            function() {
                ...
                s._intersectsWith(s.containerCache) && (i = !0, e.each(r.sortables,
                function() {
    ...
    e.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(t, n, r) {
            ...
            for (h = r.snapElements.length - 1; h >= 0; h--) {
                a = r.snapElements[h].left - r.margins.left,
                f = a + r.snapElements[h].width,
                l = r.snapElements[h].top - r.margins.top,
                c = l + r.snapElements[h].height;
                ...
                p = i || s || o || u,
                d.snapMode !== "outer" && (i = Math.abs(l - y) <= v, s = Math.abs(c - b) <= v, o = Math.abs(a - m) <= v, u = Math.abs(f - g) <= v, i && (n.position.top = r._convertPositionTo("relative", {
                    top: l,
                    left: 0
                }).top), s && (n.position.top = r._convertPositionTo("relative", {
                ...
                !r.snapElements[h].snapping && (i || s || o || u || p) && r.options.snap.snap && r.options.snap.snap.call(r.element, t, e.extend(r._uiHash(), {
                    snapItem: r.snapElements[h].item
                })),
...
define("componentLibraryJQueryUI/Draggable", ["require", "jquery-ui/draggable", "jquery-ui-touch-punch"],
function(e) {
    e("jquery-ui/draggable"),
...
define("util", ["require", "ComponentLibrary"],
function(e) {
    function n(e, t) {
    ...
    return {
        deregisterEvent: r,
        deregisterRendererEvent: i,
        deregisterBackboneEvent: n,
        setComponentReference: s,
        stopEvent: o
    }
}),
define("constants/Origin", [],
function() {
    var e = {};
    ...
    n.push(r);
    return Object.defineProperty(e, "valuesArray", {
        get: function() {
            return t
        }
    }),
...
define("lib/ui/AimPath", ["require", "util", "constants/Origin"],
function(e) {
    var t = e("util"),
    ...
    r.prototype.start = function() {
        ...
        this.model.on("change:posX change:posY", i, this),
        this.focusModel.on("change:focused", i, this),
        i.call(this)
    },
...
define("lib/ui/AnglePath", ["require", "util", "constants/Origin"],
function(e) {
    var t = e("util"),
    n = e("constants/Origin"),
    r = function() {
    ...
    var i = function() {
        var e, t = this.focusModel.getFocused();
        this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height),
...
function() {
    var e = {};
    return Object.defineProperty(e, "HEIGHT", {
        value: 500,
        enumerable: !0
    }),
    ...
    Object.defineProperty(e, "GRAVITY", {
        value: 9.81,
        enumerable: !0
    }),
    e
}),
define("lib/ui/DrawPath", ["require", "constants/Origin", "constants/Global", "util"],
function(e) {
    ...
    s.prototype.start = function() {
        this.canvas = this.renderer.$el.get(0),
        this.ctx = this.canvas.getContext("2d"),
        this.angleModel.on("change:val", u, this),
        this.velocityModel.on("change:val", u, this),
        o.call(this),
        u.call(this)
    },
    s.prototype.destroy = function() {
        r.deregisterRendererEvent(this.renderer, this.UID),
        r.deregisterBackboneEvent(this.angleModel, this),
        r.deregisterBackboneEvent(this.velocityModel, this)
    };
    var o = function() {
        var e = 8;
        this.canvas.height = n.HEIGHT - e,
    ...
    a = function() {
        ...
        do f += 1 / l,
        u = f * l + e,
        a = (f * Math.tan(s) - n.GRAVITY / 2 * Math.pow(f / (o * Math.cos(s)), 2)) * l - (r - i),
        this.ctx.lineTo(u, -a);
...
define("lib/ui/DrawLine", ["require", "constants/Origin", "constants/Global"],
function(e) {
    var t = e("constants/Origin"),
    n = e("constants/Global"),
    r = function() {
    ...
    r.prototype.start = function() {
        this.canvas = this.renderer.$el.get(0),
        this.ctx = this.canvas.getContext("2d"),
        this.model.on("change:" + this.modelKey, s, this),
        i.call(this)
    };
    var i = function() {
        var e = 8;
...
define("lib/behaviour/CreateCannonBall", [],
function() {
    var e = function() {
        this.renderer = null,
...
define("lib/behaviour/UpdateBall", ["require", "constants/Global", "constants/Origin"],
function(e) {
    ...
    r.prototype.update = function(e) {
        ...
        f *= n.RATIO,
        l *= n.RATIO,
        this.model.set("ballX", f, {
            silent: !0
        }),
        this.model.set("ballY", l, {
            silent: !0
        }),
        this.model.trigger("change:ballX"),
        this.model.trigger("change:ballY");
        if (f > o || l < -u) i.call(this),
        this.entity.destroy()
    };
    var i = function() {
        var e = this.model.getMaximumBullets() - this.model.getFiredBullets();
        e > 0 && !this.model.getLockSim() && this.model.setEnableFireButton(!0),
        this.aimHandle.reset()
    };
    return r
}),
define("lib/behaviour/UpdateFiredBullets", ["require", "util"],
function(e) {
    var t = e("util"),
    n = function() {
        this.renderer = null,
...
define("lib/behaviour/UpdateBulletsLeft", ["require", "util"],
function(e) {
    var t = e("util"),
    n = function() {
        this.renderer = null,
    ...
    n.prototype.start = function() {
        this.model.on("change:firedBullets", r, this),
        this.model.on("change:maximumBullets", r, this),
        r.call(this)
    },
    n.prototype.destroy = function() {
        t.deregisterBackboneEvent(this.model, this)
...
define("lib/behaviour/CreateTarget", ["require", "ComponentLibrary", "SceneManager", "constants/References"],
function(e) {
    var t = e("ComponentLibrary"),
    n = e("SceneManager"),
    ...
    i.prototype.start = function() {
        this.targetsModel.on("change:targets", s, this),
        s.call(this)
    };
    var s = function() {
        for (var e = 0,
        t = this.entities.length; e < t; e++) this.entities[e].destroy();
        var n = this.targetsModel.getTargets();
        for (var r = 0,
        i = n; r < i; r++) o.call(this, r + 1)
    },
    o = function(e) {
        var t = {};
        t[r.INDEX] = e;
        var n = this.targetFactory.create({
            name: "target-" + e,
            references: t
        });
        this.renderer.entity.addChild(n),
        this.entities.push(n)
    };
    return i
}),
define("lib/behaviour/DragTarget", ["require", "util"],
function(e) {
    var t = e("util"),
    n = function() {
        this.renderer = null,
    ...
    n.prototype.start = function() {
        this.renderer.$el.on("dragstart", i.bind(this)),
        this.renderer.$el.on("drag", r.bind(this)),
        this.renderer.$el.on("dragstop", s.bind(this))
    },
    n.prototype.destroy = function() {
    ...
    var r = function(e, t) {
        var n = {
            x: t.position.left + this.offsetX,
            y: this.offsetY - t.position.top
        };
        ...
        this.model.setValue("x", n.x, {
            silent: !0
        }),
        this.model.setValue("y", n.y, {
            silent: !0
        }),
...
define("lib/behaviour/TargetCollision", [],
function() {
    var e = function() {
        this.renderer = null,
        this.model = null,
    ...
    var t = function() {
        ...
        n > e - this.centerRadius && n < e + this.centerRadius && (r > t - this.centerRadius && r < t + this.centerRadius && (this.cannonModel.setBallVisible(!1), this.model.setCollisionX(n), this.model.setCollisionY(r), this.model.setDestroyed(!0), this.cannonModel.getLockSimAfterDestroy() && this.cannonModel.setLockSim(!0)), r > t + this.centerRadius && r < t + this.centerRadius + this.chipSize && !this.model.getChippedTop() && this.model.setChippedTop(!0), r > t - this.centerRadius - this.chipSize && r < t - this.centerRadius && !this.model.getChippedBottom() && this.model.setChippedBottom(!0))
    };
    return e
}),
define("lib/behaviour/DestroyTarget", [],
function() {
    var e = function() {
        this.renderer = null,
...
define("lib/behaviour/ChipTarget", [],
function() {
    var e = function() {
        this.renderer = null,
        this.explosionRenderer = null,
    ...
    e.prototype.start = function() {
        this.model.on("change:chippedTop", t, this),
        this.model.on("change:chippedBottom", n, this)
    };
    var t = function() { ! this.model.getChippedBottom() && !this.model.getDestroyed() ? this.renderer.$el.removeClass().addClass("target chippedTop") : this.model.getChippedBottom() && this.renderer.$el.removeClass().addClass("target chipped")
    },
    n = function() { ! this.model.getChippedTop() && !this.model.getDestroyed() ? this.renderer.$el.removeClass().addClass("target chippedBottom") : this.model.getChippedTop() && this.renderer.$el.removeClass().addClass("target chipped")
    };
    return e
}),
define("lib/behaviour/LockDraggable", ["require", "util"],
function(e) {
    var t = e("util"),
    n = function() {
        this.renderer = null,
    ...
    var r = function() {
        this.renderer.$el.draggable({
            disabled: this.model.getLockSim()
        })
    };
    return n
}),
define("lib/behaviour/UpdateVectors", ["require", "constants/Global", "constants/Origin"],
function(e) {
    var t = e("constants/Global"),
    n = e("constants/Origin"),
    r = function() {
    ...
    r.prototype.update = function(e) {
        ...
        this.model.setValue("vx", {
            x: this.model.getValue("ballX") + l,
            y: this.model.getValue("ballY")
        }),
        this.model.setValue("vy", {
            x: this.model.getValue("ballX"),
            y: this.model.getValue("ballY") + c
        }),
        this.model.setValue("vd", {
            x: this.model.getValue("ballX") + l,
            y: this.model.getValue("ballY") + c
        }),
        this.model.setValue("an", {
            x: this.model.getValue("ballX") + h,
            y: this.model.getValue("ballY") - p
        }),
        this.model.setValue("at", {
            x: this.model.getValue("ballX") - h,
            y: this.model.getValue("ballY") - d
        }),
        this.model.setValue("ad", {
            x: this.model.getValue("ballX"),
            y: this.model.getValue("ballY") - s
        })
    },
    r
}),
define("lib/behaviour/UpdateDistance", ["require", "constants/Origin"],
function(e) {
    function r() {
    ...
    return n.prototype.start = function() {
        this.model.on("change:" + this.modelKey, r, this),
        r.call(this)
    },
    n.prototype.destroy = function() {
...
define("lib/behaviour/AimHandle", [],
function() {
    function t() {
    ...
    return e.prototype.start = function() {
        this.capi.on("change:showHandle", t, this),
        t.call(this)
    },
...
define("lib/behaviour/TooltipPositioner", [],
function() {
    function t() {
...
define("lib/behaviour/TooltipCreator", ["require", "SceneManager"],
function(e) {
    var t = e("SceneManager"),
    n = function() {
        this.factory = null,
        this.container = t.ActiveScene,
        this.lastEntityCreated = null
    };
    return n.prototype.start = function() {
        this.container.$el.on("click." + this.UID,
        function(e) {
    ...
    n.prototype.create = function(e) {
        this.destroyLast(),
        this.lastEntityCreated = this.factory.create({
            references: e
        }),
        this.lastModel = e.model
    },
...
define("lib/behaviour/CreateTooltip", [],
function() {
    function t(e) {
        e.stopPropagation();
        if (!this.targetsModel.getAllowTargetTooltips()) return;
        this.model.getShowTooltip() ? this.tooltipCreator.destroyLast() : (this.tooltipCreator.create({
...
function() {
    ...
    u.extend(N.prototype, a, {
        ...
        _routeToRegExp: function(e) {
            return e = e.replace(A, "\\$&").replace(C, "(?:$1)?").replace(k,
            function(e, t) {
                return t ? e: "([^/]+)"
            }).replace(L, "(.*?)"),
            new RegExp("^" + e + "$")
...
define("componentLibrary-Utils/ExtendedBackboneModel", ["require", "backbone"],
function(e) {
    var t = e("backbone"),
    n = t.Model.extend({
        initialize: function() {
    ...
    r = function(e, t) {
        var n = f(e, t);
        return this[n] || a.call(this, e),
        this[n]()
    },
    i = function(e, t, n) {
        var r = l(e);
        return this[r] || a.call(this, e),
        this[r](t, n)
    },
    s = function() {
...
define("lib/model/CannonBall", ["require", "componentLibrary-Utils/ExtendedBackboneModel"],
function(e) {
...
define("lib/model/InputValue", ["require", "componentLibrary-Utils/ExtendedBackboneModel"],
function(e) {
    var t = e("componentLibrary-Utils/ExtendedBackboneModel");
    return t.extend({
        defaults: {
...
define("lib/model/Cannon", ["require", "componentLibrary-Utils/ExtendedBackboneModel"],
function(e) {
    var t = e("componentLibrary-Utils/ExtendedBackboneModel");
    return t.extend({
        defaults: {
...
define("lib/model/Targets", ["require", "componentLibrary-Utils/ExtendedBackboneModel"],
function(e) {
    var t = e("componentLibrary-Utils/ExtendedBackboneModel");
    return t.extend({
        defaults: {
...
define("lib/model/Target", ["require", "componentLibrary-Utils/ExtendedBackboneModel", "constants/Global", "constants/Origin"],
function(e) {
    var t = e("componentLibrary-Utils/ExtendedBackboneModel"),
    n = e("constants/Global"),
...
define("lib/model/Aim", ["require", "componentLibrary-Utils/ExtendedBackboneModel"],
function(e) {
    var t = e("componentLibrary-Utils/ExtendedBackboneModel");
    return t.extend({
        defaults: {
...
define("lib/capi/InputValue", ["require", "componentLibrary-Utils/ExtendedBackboneModel", "api/snapshot/adapters/BackboneAdapter"],
function(e) {
    var t = e("componentLibrary-Utils/ExtendedBackboneModel"),
    ...
    return t.extend({
        ...
        start: function() {
            ...
            n.expose("val", this, {
                alias: "Cannon Data." + this.alias,
                description: this.alias + " value"
            }),
            n.expose("minVal", this, {
                alias: "Cannon Data.Min " + this.alias,
                description: "Minim " + this.alias + " value"
            }),
            n.expose("maxVal", this, {
                alias: "Cannon Data.Max " + this.alias,
                description: "Maxim " + this.alias + " value"
            }),
            n.expose("show", this, {
                alias: "Cannon InfoPanel.Show " + this.alias,
                description: this.alias + " visibility"
            }),
            n.expose("allowEdit", this, {
                alias: "Cannon InfoPanel.Allow " + this.alias + " Change",
                description: "Allow change of " + this.alias + " value"
            })
        },
        getVal: function() {
            return this.get("val")
...
define("lib/capi/Cannon", ["require", "componentLibrary-Utils/ExtendedBackboneModel", "api/snapshot/adapters/BackboneAdapter"],
function(e) {
    var t = e("componentLibrary-Utils/ExtendedBackboneModel"),
    n = e("api/snapshot/adapters/BackboneAdapter").getInstance();
    return t.extend({
        ...
        start: function() {
            n.expose("showBulletPath", this, {
                alias: "Cannon.Show Bullet Path",
                description: "Show Bullet Path"
            }),
            n.expose("firedBullets", this, {
                alias: "Cannon.Num Of Bullets Fired",
                description: "Number of Fired Bullets"
            }),
            n.expose("showBulletsLeft", this, {
                alias: "Cannon.Show Bullets Left",
                description: "Show Bullets Left"
            }),
            n.expose("maximumBullets", this, {
                alias: "Cannon.Max Bullets",
                description: "Maximum Allowed Bullets"
            }),
            n.expose("yVelocityAfter10sec", this, {
                alias: "Cannon.Y Velocity After 10 secs",
                description: "Reports the velocity along Y axis after 10 seconds of bullet in flight",
                readonly: !0
            }),
            n.expose("radiusOfCurvature", this, {
                alias: "Cannon.Radius Of Curvature",
                description: "Reports the radius of curvature of the bullet"
            }),
            n.expose("lockSimAfterDestroy", this, {
                alias: "Cannon Data.Lock Sim After Destroy",
                description: ""
            }),
            n.expose("enableFireButton", this, {
                alias: "Cannon InfoPanel.Fire Button Enabled",
                description: "Enable Fire Button"
            }),
            n.expose("showBulletGhost", this, {
                alias: "Cannon.Show Bullet Ghost",
                description: "Show Bullet Ghost"
            }),
            n.expose("showBulletAccelerationVector", this, {
                alias: "Cannon.Show Bullet Acceleration Vector",
                description: "Show Bullet Acceleration Vector"
            }),
            n.expose("showBulletVelocityVector", this, {
                alias: "Cannon.Show Bullet Velocity Vector",
                description: "Show Bullet Velocity Vector"
            }),
            n.expose("timeOfFlight", this, {
                alias: "Cannon.Time Of Flight",
                description: "Time of Flight of last fired bullet"
            }),
            n.expose("initialXVelocity", this, {
                alias: "Cannon.Initial X Velocity",
                description: "Initial x velocity of the last fired bullet"
            }),
            n.expose("initialYVelocity", this, {
                alias: "Cannon.Initial Y Velocity",
                description: "Initial y velocity of the last fired bullet"
            }),
            n.expose("distanceTravelled", this, {
                alias: "Cannon.Distance Travelled",
                description: "The distance travelled by the last fired bullet"
            })
        },
        getShowBulletPath: function() {
            return this.get("showBulletPath")
...
define("lib/capi/Targets", ["require", "componentLibrary-Utils/ExtendedBackboneModel", "api/snapshot/adapters/BackboneAdapter"],
function(e) {
    var t = e("componentLibrary-Utils/ExtendedBackboneModel"),
    n = e("api/snapshot/adapters/BackboneAdapter").getInstance();
    return t.extend({
        ...
        start: function() {
            n.expose("targets", this, {
                alias: "Target.Number Of Targets",
                description: "Number of total targets"
            }),
            n.expose("showTooltip", this, {
                alias: "Target.Show Target Info",
                description: "Tooltip Visibility"
            }),
            n.expose("allowTargetDrag", this, {
                alias: "Target.Allow Target Position Change ",
                description: "Allow Drag of Targets"
            }),
            n.expose("allowTargetTooltips", this, {
                alias: "Target.Allow Targets to Show Tooltips",
                description: "Allow Targets to Show Tooltips on click"
            })
        },
        getTargets: function() {
            return this.get("targets")
...
define("lib/capi/Target", ["require", "componentLibrary-Utils/ExtendedBackboneModel", "api/snapshot/adapters/BackboneAdapter"],
function(e) {
    var t = e("componentLibrary-Utils/ExtendedBackboneModel"),
    n = e("api/snapshot/adapters/BackboneAdapter").getInstance(),
    r = t.extend({
        ...
        expose: function() {
            n.expose("x", this, {
                alias: "Target Data.Target " + this.getValue("id") + ".X Position",
                description: "Target X Position"
            }),
            n.expose("y", this, {
                alias: "Target Data.Target " + this.getValue("id") + ".Y Position",
                description: "Target Y Position"
            }),
            n.expose("visible", this, {
                alias: "Target Data.Target " + this.getValue("id") + ".Visible",
                description: "Target Visibility"
            }),
            n.expose("destroyed", this, {
                alias: "Target Data.Target " + this.getValue("id") + ".Destroyed",
                description: "If target is destroyed"
            }),
        ...
        unexpose: function() {
            n.unexpose("x", this),
            n.unexpose("y", this),
            n.unexpose("visible", this),
            n.unexpose("destroyed", this),
            n.unexpose("collisionYDiff", this)
        }
    });
    return r
}),
define("lib/capi/Aim", ["require", "componentLibrary-Utils/ExtendedBackboneModel", "api/snapshot/adapters/BackboneAdapter"],
function(e) {
    var t = e("componentLibrary-Utils/ExtendedBackboneModel"),
    n = e("api/snapshot/adapters/BackboneAdapter").getInstance();
    return t.extend({
        ...
        start: function() {
            n.expose("showHandle", this, {
                alias: "Cannon InfoPanel.Show Controller Handle",
                description: "Controller Handle visibility"
            }),
            n.expose("showGuidelines", this, {
                alias: "Cannon InfoPanel.Show GuideLines",
                description: "GuideLines visibility"
            })
        },
...
define("componentLibrary-Sync/ModelToInput", [],
function() {
    var e = function() {
        this.model = null,
        this.modelKey = "",
    ...
    e.prototype.start = function() {
        this.renderer.$el.on("change." + this.UID, n.bind(this)),
        this.model.on("change:" + this.modelKey, t, this),
        t.call(this)
    },
    e.prototype.destroy = function() {
        this.renderer && this.renderer.$el && this.renderer.$el.off && this.renderer.$el.off("." + this.UID),
    ...
    n = function() {
        ...
        this.validator && (e = this.validator.validate(e), this.renderer.$el.val(e + this.suffix)),
        this.model.setValue(this.modelKey, e)
    };
    return e
}),
define("componentLibrary-Sync/ToggleVisibility", [],
function() {
    function t() {
        var e = this.model.getValue(this.modelKey) === this.modelKeyValue;
        this.matching || (e = !e),
        this.renderer.$el.toggle(e)
    }
    var e = function() {
        this.model = null,
        this.modelKey = "",
...
define("componentLibrary-Sync/ToggleClass", [],
function() {
    function t() {
        var e = this.model.getValue(this.modelKey) === this.modelKeyValue;
        this.matching || (e = !e),
        this.renderer.$el.toggleClass(this.className, e)
    }
    var e = function() {
        this.model = null,
        this.renderer = null,
...
define("componentLibrary-Sync/ModelToModel", [],
function() {
    var e = function() {
        this.modelA = null,
        this.modelAKey = null,
    ...
    e.prototype.start = function() {
        this.modelA.on("change:" + this.modelAKey, n, this),
        this.modelB.on("change:" + this.modelBKey, t, this),
        n.call(this),
        t.call(this)
    },
    e.prototype.destroy = function() {
        this.modelB && this.modelB.off && this.modelB.off(null, null, this),
        this.modelA && this.modelA.off && this.modelA.off(null, null, this)
    };
    var t = function() {
...
define("componentLibrary-Sync/ModelToText", [],
function() {
    function t() {
...
define("componentLibrary-Sync/ModelToNumericProperty", [],
function() {
    function t() {
...
define("componentLibrary-Sync/ToggleProperty", [],
function() {
    function t() {
        var e = this.model.getValue(this.modelKey) === this.modelKeyValue;
        this.matching || (e = !e),
...
define("componentLibrary-Sync/SetOnEvent", [],
function() {
    function t() {
...
define("componentLibrary-Sync/ModelToProperty", [],
function() {
    function t() {
...
function() {
    ...
    return e.prototype.getMagnitude = function() {
        return Math.sqrt(Math.pow(this.x, 2) + Math.pow(this.y, 2))
    },
    e.prototype.normalize = function() {
        var e = this.getMagnitude();
        return this.x = this.x / e,
        this.y = this.y / e,
        this
    },
...
define("lib/sync/DraggableToModel", ["require", "utils/Point"],
function(e) {
    var t = e("utils/Point"),
    n = function() {
        this.model = null,
    ...
    var r = function(e, n) {
        ...
        this.model.setValue(this.xKey, r.x, {
            silent: !0
        }),
        this.model.setValue(this.yKey, r.y, {
            silent: !0
        }),
...
define("lib/sync/AngleInput", ["require", "util", "utils/Point"],
function(e) {
    function i() {
    ...
    function s() {
        ...
        s = n.distance(e, t);
        this.aimModel.setValue("posX", s * i.x, {
            silent: !0
        }),
        this.aimModel.setValue("posY", s * i.y, {
            silent: !0
        }),
    ...
    return r.prototype.start = function() {
        this.inputModel.on("change:val", s, this),
        this.aimModel.on("change", i, this),
        s.call(this)
    },
    r.prototype.destroy = function() {
        t.deregisterBackboneEvent(this.inputModel, this),
        t.deregisterBackboneEvent(this.aimModel, this)
    },
    r
}),
define("lib/sync/VelocityInput", ["require", "util", "utils/Point", "constants/Origin"],
function(e) {
    function s() {
        var e = new n(this.aimModel.getPosX(), this.aimModel.getPosY()),
        t = e.distance(),
    ...
    function o() {
        ...
        o = s - i,
        u = (t - i) * r.RADIUS / o;
        this.aimModel.setValue("posX", u * e.x, {
            silent: !0
        }),
        this.aimModel.setValue("posY", u * e.y, {
            silent: !0
        }),
        this.aimModel.trigger("change:posX"),
        this.aimModel.trigger("change:posY")
    ...
    return i.prototype.start = function() {
        this.inputModel.on("change:val", o, this),
        this.aimModel.on("change", s, this),
        o.call(this)
    },
...
define("lib/sync/LockSim", ["require", "util"],
function(e) {
    var t = e("util"),
    n = function() {
        this.model = null
    ...
    n.prototype.start = function() {
        this.model.on("change:lockSimAfterDestroy", r, this),
        r.call(this)
    },
    n.prototype.destroy = function() {
        t.deregisterBackboneEvent(this.model, this)
...
define("lib/sync/Cannon", ["require", "util", "constants/Global"],
function(e) {
    var t = e("util"),
    n = e("constants/Global"),
    r = function() {
    ...
    r.prototype.start = function() {
        i.call(this),
        this.velocityModel.on("change:val", i, this),
        this.angleModel.on("change:val", i, this)
    },
    r.prototype.destroy = function() {
        t.deregisterBackboneEvent(this.inputModel, this)
    };
    var i = function() {
        ...
        this.cannonModel.setYVelocityAfter10sec(r),
        this.cannonModel.setRadiusOfCurvature(i)
    };
    return r
}),
define("lib/sync/Flight", ["require", "util", "constants/Origin"],
function(e) {
    var t = e("util"),
    n = e("constants/Origin"),
    r = function() {
...
define("lib/sync/ToggleRendererProperty", [],
function() {
    var e = function() {
        this.models = null,
        this.modelKeys = null,
...
function() {
    ...
    e.prototype.start = function() {
        this.model.on("change:" + this.value + " change:" + this.minValue + " change:" + this.maxValue, t, this),
        t.call(this)
    },
...
define("lib/validator/AimPosition", ["require", "utils/Point", "constants/Origin"],
function(e) {
    function i(e) {
    ...
    return r.prototype.validate = function(e) {
        var t;
        e.x = Math.max(e.x, 1),
        e.y = Math.max(e.y, 0),
        this.exitVelocityModel.getAllowEdit() || i.call(this, e),
        this.angleModel.getAllowEdit() || s.call(this, e);
        if (e.x === 0 && e.y === 0) return;
        t = e.clone().normalize(),
        e.distance() > this.radius && (e.x = this.radius * t.x, e.y = this.radius * t.y)
    },
    r
}),
define("lib/validator/TargetPosition", [],
function() {
    var e = function() {
        this.parentWidth = 0,
        this.parentHeight = 0,
...
define("components", ["require", "componentLibrary-Renderers/HtmlRenderer", "componentLibrary-Renderers/TextRenderer", "componentLibrary-Renderers/TemplateRenderer", "componentLibraryJQueryUI/Draggable", "lib/ui/AimPath", "lib/ui/AnglePath", "lib/ui/DrawPath", "lib/ui/DrawLine", "lib/behaviour/CreateCannonBall", "lib/behaviour/UpdateBall", "lib/behaviour/UpdateFiredBullets", "lib/behaviour/UpdateBulletsLeft", "lib/behaviour/CreateTarget", "lib/behaviour/DragTarget", "lib/behaviour/TargetCollision", "lib/behaviour/DestroyTarget", "lib/behaviour/ChipTarget", "lib/behaviour/LockDraggable", "lib/behaviour/UpdateVectors", "lib/behaviour/UpdateDistance", "lib/behaviour/AimHandle", "lib/behaviour/TooltipPositioner", "lib/behaviour/TooltipCreator", "lib/behaviour/CreateTooltip", "lib/model/CannonBall", "lib/model/InputValue", "lib/model/Cannon", "lib/model/Targets", "lib/model/Target", "lib/model/Aim", "lib/capi/InputValue", "lib/capi/Cannon", "lib/capi/Targets", "lib/capi/Target", "lib/capi/Aim", "componentLibrary-Sync/ModelToInput", "componentLibrary-Sync/ToggleVisibility", "componentLibrary-Sync/ToggleClass", "componentLibrary-Sync/ModelToModel", "componentLibrary-Sync/ModelToText", "componentLibrary-Sync/ModelToNumericProperty", "componentLibrary-Sync/ToggleProperty", "componentLibrary-Sync/SetOnEvent", "componentLibrary-Sync/ModelToProperty", "lib/sync/DraggableToModel", "lib/sync/AngleInput", "lib/sync/VelocityInput", "lib/sync/LockSim", "lib/sync/Cannon", "lib/sync/Flight", "lib/sync/ToggleRendererProperty", "lib/validator/Number", "lib/validator/Range", "lib/validator/AimPosition", "lib/validator/TargetPosition"],
function(e) {
    return {
...
define("scenes/config", ["require", "constants/Origin", "constants/Global", "constants/References"],
function(e) {
    var t = e("constants/Origin"),
    n = e("constants/Global"),
    r = e("constants/References");
    return {
        ...
        factories: {
            tooltip: {
                components: {
                    renderer: {
                        componentName: "ui/htmlRenderer",
                        "class": "tooltip"
                    },
                    positioner: {
                        componentName: "behaviour/tooltipPositioner",
                        target: "~renderer",
                        renderer: "&renderer"
                    }
                },
                        ...
                        children: {
                            horizontalValue: {
                                components: {
                                    ...
                                    syncDistanceX: {
                                        componentName: "behaviour/updateDistance",
            ...
            cannonBall: {
                components: {
                    renderer: {
                        componentName: "ui/htmlRenderer",
                        "class": "ball",
                        parent: "&boundariesWrapper.renderer"
                    },
                    model: {
                        componentName: "model/cannonBall"
                    },
                    syncX: {
                        componentName: "sync/modelToNumericProperty",
                        target: "&renderer",
                        property: "x",
                        model: "&cannon.model",
                        offset: t.X,
                    ...
                    syncEnableFireButton: {
                        componentName: "sync/toggleClass",
                        renderer: "&fireButton.renderer",
                        model: "&cannon.model",
                        modelKey: "enableFireButton",
                        modelKeyValue: !1,
                        className: "disabled"
                    },
                    updateBall: {
                        componentName: "behaviour/updateBall",
                        model: "&cannon.model",
                        angleModel: "&angle.model",
                        velocityModel: "&exitVelocity.model",
                        aimHandle: "&aim.aimHandle"
                    },
                    updateVectors: {
                        componentName: "behaviour/updateVectors",
                        model: "&cannon.model",
                        angleModel: "&angle.model",
                        velocityModel: "&exitVelocity.model"
                    }
                ...
                children: {
                    ghostBallX: {
                        components: {
                            ...
                            syncBulletGhostX: {
                                componentName: "sync/toggleVisibility",
                                model: "&cannon.model",
                                modelKey: "showBulletGhost",
                                modelKeyValue: !0,
                                renderer: "&renderer"
                            },
                            syncX: {
                    ...
                    velocityLineX: {
                        components: {
                            ...
                            toggle: {
                                ...
                                renderer: "&renderer",
                                model: "&cannon.model",
                                modelKey: "showBulletVelocityVector",
                                modelKeyValue: !0
                            }
                        }
                    },
                    ...
                    accelerationLineNormal: {
                        components: {
                            ...
                            toggle: {
                                ...
                                renderer: "&renderer",
                                model: "&cannon.model",
                                modelKey: "showBulletAccelerationVector",
                                modelKeyValue: !0
                            }
                        }
                    },
            ...
            target: {
                components: {
                    capi: {
                        componentName: "capi/target",
                        id: r.INDEX
                    },
                    model: {
                        componentName: "model/target",
                        id: r.INDEX
                    },
                    renderer: {
                        componentName: "ui/htmlRenderer",
                    ...
                    syncX: {
                        componentName: "sync/modelToModel",
                        modelA: "&capi",
                        modelAKey: "x",
                        modelB: "&model",
                        modelBKey: "x"
                    ...
                    targetCollision: {
                        componentName: "behaviour/targetCollision",
                        renderer: "&renderer",
                        model: "&model",
                        cannonModel: "&cannon.model"
                    },
                    destroyTarget: {
                        componentName: "behaviour/destroyTarget",
                        renderer: "&renderer",
                        explosionRenderer: "&explosion",
                        model: "&model"
                    },
                    updateFlight: {
                        componentName: "sync/flight",
                        targetModel: "&model",
                        velocityModel: "&exitVelocity.model",
                        angleModel: "&angle.model",
                        cannonModel: "&cannon.model"
                    ...
                    syncCollisionYDiff: {
                        componentName: "sync/modelToModel",
                        modelA: "&capi",
                        modelAKey: "collisionYDiff",
                        modelB: "&model",
                        modelBKey: "collisionYDiff"
                    },
                    chipTarget: {
                        componentName: "behaviour/chipTarget",
                        renderer: "&renderer",
                        explosionRenderer: "&explosion",
                        model: "&model"
                    },
                    draggable: {
                        componentName: "ui/draggable",
                        renderer: "&renderer"
                    },
                    validator: {
                        componentName: "validator/targetPosition",
                        offsetX: t.X,
                        offsetY: t.Y,
                        parentWidth: n.WIDTH,
                    ...
                    dragTarget: {
                        componentName: "behaviour/dragTarget",
                        model: "&model",
                        targetsModel: "&targets.targetsModel",
                        renderer: "&renderer",
                        validator: "&validator",
                        offsetX: -t.X,
                        offsetY: t.Y
                    ...
                    createTooltip: {
                        componentName: "behaviour/createTooltip",
                        model: "&model",
                        targetsModel: "&targets.targetsModel",
                        renderer: "&renderer",
                        tooltipCreator: "&tooltipCreator.creator"
                    }
                }
            }
        },
        entities: {
            cannon: {
                components: {
                    ...
                    capi: {
                        componentName: "capi/cannon"
                    },
                    model: {
                        componentName: "model/cannon"
                    },
                    LockSim: {
                        componentName: "sync/lockSim",
                        model: "&model"
                    },
                    syncShowBulletsLeft: {
                        componentName: "sync/modelToModel",
                        modelA: "&capi",
                        modelAKey: "showBulletsLeft",
                        modelB: "&model",
                        modelBKey: "showBulletsLeft"
                    },
                    syncMaximumBullets: {
                        componentName: "sync/modelToModel",
                        modelA: "&capi",
                        modelAKey: "maximumBullets",
                        modelB: "&model",
                        modelBKey: "maximumBullets"
                    },
                    syncData: {
                        componentName: "sync/cannon",
                        velocityModel: "&exitVelocity.model",
                        angleModel: "&angle.model",
                        cannonModel: "&model"
                    },
                    syncShowBulletPath: {
                        componentName: "sync/modelToModel",
                        modelA: "&capi",
                        modelAKey: "showBulletPath",
                        modelB: "&model",
                        modelBKey: "showBulletPath"
                    },
                    syncRotation: {
                        componentName: "sync/modelToNumericProperty",
                        target: "&renderer",
                    ...
                    syncLockSimAfterDestroy: {
                        componentName: "sync/modelToModel",
                        modelA: "&capi",
                        modelAKey: "lockSimAfterDestroy",
                        modelB: "&model",
                        modelBKey: "lockSimAfterDestroy"
                    },
                    syncShowBulletGhost: {
                        componentName: "sync/modelToModel",
                        modelA: "&capi",
                        modelAKey: "showBulletGhost",
                        modelB: "&model",
                        modelBKey: "showBulletGhost"
                    },
                    syncShowBulletAccelerationVector: {
                        componentName: "sync/modelToModel",
                        modelA: "&capi",
                        modelAKey: "showBulletAccelerationVector",
                        modelB: "&model",
                        modelBKey: "showBulletAccelerationVector"
                    },
                    showBulletVelocityVector: {
                        componentName: "sync/modelToModel",
                        modelA: "&capi",
                        modelAKey: "showBulletVelocityVector",
                        modelB: "&model",
                        modelBKey: "showBulletVelocityVector"
                    },
                    syncYVelocityAfter10sec: {
                        componentName: "sync/modelToModel",
                        modelA: "&model",
                        modelB: "&capi",
                        modelAKey: "yVelocityAfter10sec",
                        modelBKey: "yVelocityAfter10sec"
                    },
                    syncRadiusOfCurvature: {
                        componentName: "sync/modelToModel",
                        modelA: "&model",
                        modelB: "&capi",
                        modelAKey: "radiusOfCurvature",
                        modelBKey: "radiusOfCurvature"
                    },
                    syncTimeOfFlight: {
                        componentName: "sync/modelToModel",
                        modelA: "&model",
                        modelB: "&capi",
                        modelAKey: "timeOfFlight",
                        modelBKey: "timeOfFlight"
                    },
                    syncInitialXVelocity: {
                        componentName: "sync/modelToModel",
                        modelA: "&model",
                        modelB: "&capi",
                        modelAKey: "initialXVelocity",
                        modelBKey: "initialXVelocity"
                    },
                    syncInitialYVelocity: {
                        componentName: "sync/modelToModel",
                        modelA: "&model",
                        modelB: "&capi",
                        modelAKey: "initialYVelocity",
                        modelBKey: "initialYVelocity"
                    },
                    syncDistanceTravelled: {
                        componentName: "sync/modelToModel",
                        modelA: "&model",
                        modelB: "&capi",
                        modelAKey: "distanceTravelled",
                        modelBKey: "distanceTravelled"
                    }
                }
            },
            exitVelocity: {
                components: {
                    ...
                    model: {
                        componentName: "model/inputValue"
                    },
                    capi: {
                        componentName: "capi/inputValue",
                        alias: "Exit Velocity",
                        minValue: 1,
                        maxValue: 300
                    },
                    ...
                    syncWithAim: {
                        componentName: "sync/velocityInput",
                        cannonModel: "&cannon.model",
                        inputModel: "&model",
                        aimModel: "&aim.model"
                    },
                ...
                children: {
                    input: {
                        components: {
                            ...
                            validator: {
                                componentName: "validator/number"
                            },
                            sync: {
                                componentName: "sync/modelToInput",
                                renderer: "&renderer",
                                model: "&^.model",
                                modelKey: "val",
                                validator: "&validator"
            ...
            aim: {
                components: {
                    ...
                    model: {
                        componentName: "model/aim"
                    },
                    capi: {
                        componentName: "capi/aim"
                    },
                    draggable: {
                        componentName: "ui/draggable",
                        renderer: "&renderer"
                    ...
                    validator: {
                        componentName: "validator/aimPosition",
                        radius: t.RADIUS,
                        exitVelocityModel: "&exitVelocity.model",
                        angleModel: "&angle.model"
                    },
                    draggableToModel: {
                        componentName: "sync/draggableToModel",
                        model: "&model",
                        renderer: "&renderer",
                        validator: "&validator",
                        xKey: "posX",
                    ...
                    aimHandle: {
                        componentName: "behaviour/aimHandle",
                        capi: "&capi",
                        model: "&model"
                    },
                    syncShowGuidelines: {
                        componentName: "sync/modelToModel",
                        modelA: "&capi",
                        modelAKey: "showGuidelines",
                        modelB: "&model",
                        modelBKey: "showGuidelines"
                    },
                    toggle: {
                        componentName: "sync/toggleClass",
                        model: "&model",
                    ...
                    toggleVelocity: {
                        ...
                        modelKey: "allowEdit",
                        modelKeyValue: !1,
                        className: "velocityDisabled"
                    },
                    lockSim: {
                        componentName: "behaviour/lockDraggable",
                        model: "&cannon.model",
                        renderer: "&renderer"
                    }
                }
                    ...
                    label: {
                        components: {
                            renderer: {
                                componentName: "ui/textRenderer",
                                type: "label",
                                text: "Cannon Angle (" + String.fromCharCode(176) + ")",
                                attributes: {
                                    "for": "inputAngle"
                                }
                            }
            ...
            aimPath: {
                components: {
                    ...
                    drawPath: {
                        componentName: "ui/aimPath",
                        renderer: "&renderer",
                        model: "&aim.model",
                        focusModel: "&exitVelocity.model"
                    },
                    toggle: {
                        componentName: "sync/toggleClass",
                        model: "&aim.model",
                        renderer: "&renderer",
                        modelKey: "showGuidelines",
                        modelKeyValue: !0,
                        matching: !1,
                        className: "isHidden"
                    }
            ...
            anglePath: {
                components: {
                    ...
                    drawPath: {
                        componentName: "ui/anglePath",
                        renderer: "&renderer",
                        model: "&aim.model",
                        angleModel: "&angle.model",
                        focusModel: "&angle.model"
                    },
                    toggle: {
                        componentName: "sync/toggleClass",
                        model: "&aim.model",
            ...
            fireButton: {
                components: {
                    ...
                    updateFiredBullets: {
                        componentName: "behaviour/updateFiredBullets",
                        renderer: "&renderer",
                        model: "&cannon.model"
                    },
                    syncFiredBullets: {
                        componentName: "sync/modelToModel",
                        modelA: "&cannon.capi",
                        modelAKey: "firedBullets",
                        modelB: "&cannon.model",
                        modelBKey: "firedBullets"
                    },
                    toggleDisabled: {
                        componentName: "sync/toggleClass",
                        renderer: "&renderer",
                    ...
                    syncEnableFireButton: {
                        componentName: "sync/modelToModel",
                        modelA: "&cannon.capi",
                        modelAKey: "enableFireButton",
                        modelB: "&cannon.model",
                        modelBKey: "enableFireButton"
                    },
                    createCannonBall: {
                        componentName: "behaviour/createCannonBall",
                        renderer: "&renderer",
                        cannonBallFactory: "+cannonBall",
                        model: "&cannon.model",
                        aimHandle: "&aim.aimHandle"
                    }
                }
            ...
            bullets: {
                components: {
                    ...
                    updateBulletsLeft: {
                        componentName: "behaviour/updateBulletsLeft",
                        renderer: "&renderer",
                        model: "&cannon.model"
                    },
                    toggleBullets: {
            ...
            targets: {
                components: {
                    ...
                    targetsCapi: {
                        componentName: "capi/targets"
                    },
                    targetsModel: {
                        componentName: "model/targets"
                    },
                    renderer: {
                        componentName: "ui/htmlRenderer",
                        "class": "bullets showThree"
                    ...
                    syncShowTooltip: {
                        componentName: "sync/modelToModel",
                        modelA: "&targetsCapi",
                        modelAKey: "showTooltip",
                        modelB: "&targetsModel",
                        modelBKey: "showTooltip"
                    },
                    syncAllowTargetDrag: {
                        componentName: "sync/modelToModel",
                        modelA: "&targetsCapi",
                        modelAKey: "allowTargetDrag",
                        modelB: "&targetsModel",
                        modelBKey: "allowTargetDrag"
                    },
                    syncAllowTooltips: {
                        componentName: "sync/modelToModel",
                        modelA: "&targetsCapi",
                        modelAKey: "allowTargetTooltips",
                        modelB: "&targetsModel",
                        modelBKey: "allowTargetTooltips"
                    },
                    createTarget: {
                        componentName: "behaviour/createTarget",
            ...
            tooltipCreator: {
                components: {
                    creator: {
                        componentName: "behaviour/tooltipCreator",
                        factory: "+tooltip"
                    }
                }
            }
...
define("scenes/index", ["require", "scenes/config"],
function(e) {
    return {
        pauseOnBlur: !1,
        scenes: [e("scenes/config")]
    }
}),
define("main", ["require", "jquery", "sim-common/Detect", "sim-common/VersionCheck", "text!sim-common/templates/notSupported.html", "api/snapshot/adapters/BackboneAdapter", "api/snapshot/Controller", "api/snapshot/Transporter", "ComponentLibrary", "components", "SceneManager", "scenes/index"],
function(e) {
    function c() {
        l.parent = n,
        u.init(a),
    ...
    function h() {
        o.addInitialSetupCompleteListener(c),
        s.notifyOnReady()
    }
    var t = e("jquery"),
    n;
    e("sim-common/Detect"),
    e("sim-common/VersionCheck");
